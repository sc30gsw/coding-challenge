    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="rounded-lg bg-white p-6">
        ...
        <div className="text-center">
          <h1 className="font-bold text-gray-900 text-2xl sm:text-3xl">シミュレーション結果</h1>
      ...
      <div className="rounded-lg bg-white p-6 shadow-sm">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-lg border border-green-200 bg-green-50 p-4">
            <div className="text-center">
              ...
              <p className="mt-1 font-bold text-green-800 text-2xl">
        ...
        <div className="mt-4 rounded-lg bg-red-50 p-4 text-center">
          ...
          <p className="mt-1 font-bold text-red-800 text-3xl">
      ...
      <div className="rounded-lg bg-white p-6 text-center">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <button className="rounded-lg bg-red-500 px-6 py-3 font-medium text-white transition-colors hover:bg-red-600">
            お問い合わせ
          </button>
        </div>
      </div>
