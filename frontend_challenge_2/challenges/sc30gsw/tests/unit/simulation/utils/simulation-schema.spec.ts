  ...
  describe("customValidations", () => {
    ...
    describe("validatePlanCapacityCombination", () => {
      it("関西電力従量電灯Aでは契約容量nullが有効", () => {
        expect(customValidations.validatePlanCapacityCombination("kepco", "juryoA", null)).toBe(
          true,
        )
        expect(
          customValidations.validatePlanCapacityCombination("kepco", "juryoA", undefined),
        ).toBe(true)
      })
